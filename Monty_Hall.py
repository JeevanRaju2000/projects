...
print('Monty Hall Problem with {} doors'.format(3))
print('Proportion of wins without switching: {:.4f}'.format(1/3))
print('Proportion of wins with switching: {:.4f}'.format(2/3))